                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center">
                            <a href="javascript:void(0)" class="dropdown-item text-center user pb-0 font-weight-bold">{{ auth()->user()->fullname }}</a>
                            <!-- <span class="text-center user-semi-title">{{ auth()->user()->fullname }}</span> -->
                        ...
                        <a class="dropdown-item d-flex" href="javascript:void(0)" onclick="$('#form-logout').submit()">
